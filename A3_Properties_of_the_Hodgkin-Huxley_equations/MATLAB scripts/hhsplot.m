...
title('Ionic conductances','Color','w'),legend('\color{white} Gna','\color{white} Gk');
...
title('Ionic currents','Color','w'),legend('\color{white} Jna','\color{white} Jk','\color{white} Jcl');
